    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="card card-body bg-light mt-5">
                ...
                <form action="<?php echo URLROOT; ?>/ships/edit/<?php echo $data['id']; ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name='code' class="form-control form-control-lg <?php  echo(!empty
                        ($data['code_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['code']; ?>">
