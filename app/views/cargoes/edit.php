    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="card card-body bg-light mt-5">
                ...
                <form action="<?php echo URLROOT; ?>/cargoes/edit/<?php echo $data['id']; ?>" method="post">
                    ...
                    <div class="form-group">
                        <label for="name">Unit: <sup>*</sup></label>
                        <input type="text" name='unit' class="form-control form-control-lg <?php  echo(!empty
                        ($data['unit_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['unit']; ?>">
