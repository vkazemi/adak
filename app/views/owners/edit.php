    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="card card-body bg-light mt-5">
                ...
                <form action="<?php echo URLROOT; ?>/owners/edit/<?php echo $data['id']; ?>" method="post">
                    ...
                    <div class="form-group">
                        <label for="name">post code: <sup>*</sup></label>
                        <input type="text" name='post_code' class="form-control form-control-lg <?php  echo(!empty
                        ($data['post_code_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['post_code']; ?>">
